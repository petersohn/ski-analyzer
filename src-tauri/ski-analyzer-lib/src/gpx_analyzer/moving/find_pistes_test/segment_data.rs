...
pub fn segments0() -> Vec<TrackSegment> {
    vec![segment(&[
...
pub fn segments_enter_leave() -> Vec<TrackSegment> {
    vec![segment(&[
...
pub fn segments_follow_piste() -> Vec<TrackSegment> {
    vec![segment(&[
...
pub fn segments_leave_for_short_time() -> Vec<TrackSegment> {
    vec![segment(&[
...
pub fn segments_multiple0() -> Vec<TrackSegment> {
    vec![
        segment(&[
            (6.5242699, 45.3103999),
            (6.5244429, 45.3103474),
            (6.5246555, 45.3102731),
            (6.5248504, 45.3102483),
            (6.5250674, 45.3102298),
            (6.5252962, 45.3102244),
            (6.5255778, 45.3102091),
            (6.5258457, 45.3102033),
            (6.5260662, 45.3101798),
            (6.5263134, 45.3101744),
            (6.5265731, 45.3101441),
            (6.526765, 45.3101196),
            (6.5269893, 45.3100542),
            (6.52721, 45.3100149),
            (6.5273972, 45.3100642),
            (6.5274073, 45.3102085),
            (6.5273412, 45.31042),
            (6.5272827, 45.3106599),
            (6.5271298, 45.310851),
            (6.5268514, 45.3110442),
        ]),
        segment(&[
            (6.5263516, 45.3125132),
            (6.5264586, 45.3126036),
            (6.526584, 45.3127126),
            (6.5267171, 45.3128389),
            (6.5269204, 45.3129838),
            (6.527039, 45.3131492),
            (6.5271288, 45.3133399),
            (6.5272685, 45.3134604),
            (6.5274074, 45.3136343),
            (6.5275836, 45.3138112),
            (6.5277685, 45.3139901),
        ]),
    ]
}

pub fn segments_multiple1() -> Vec<TrackSegment> {
    vec![
        segment(&[
            (6.5244657, 45.3115331),
            (6.5246798, 45.3118069),
            (6.524952, 45.3120357),
            (6.5252521, 45.3121623),
            (6.5257046, 45.3123481),
            (6.5261057, 45.3125647),
        ]),
        segment(&[
            (6.5267099, 45.3136609),
            (6.5271199, 45.3138968),
            (6.5275945, 45.3141313),
            (6.5280575, 45.3144348),
            (6.5285038, 45.3146852),
            (6.5289641, 45.3150311),
            (6.5292944, 45.3156003),
            (6.5293088, 45.3161029),
        ]),
    ]
}
